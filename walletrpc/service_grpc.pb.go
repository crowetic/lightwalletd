...
type CompactTxStreamerClient interface {
	...
	// The block can be specified by either height or hash.
	GetBridgeTreeState(ctx context.Context, in *BlockID, opts ...grpc.CallOption) (*TreeState, error)
...
func (c *compactTxStreamerClient) GetBridgeTreeState(ctx context.Context, in *BlockID, opts ...grpc.CallOption) (*TreeState, error) {
	out := new(TreeState)
	err := c.cc.Invoke(ctx, "/pirate.wallet.sdk.rpc.CompactTxStreamer/GetBridgeTreeState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CompactTxStreamerServer interface {
	...
	// This uses the updated z_gettreestate RPC which includes the new bridge trees format.
	// The block can be specified by either height or hash.
	GetBridgeTreeState(context.Context, *BlockID) (*TreeState, error)
...
func (UnimplementedCompactTxStreamerServer) GetBridgeTreeState(context.Context, *BlockID) (*TreeState, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBridgeTreeState not implemented")
}
...
func _CompactTxStreamer_GetBridgeTreeState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlockID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompactTxStreamerServer).GetBridgeTreeState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pirate.wallet.sdk.rpc.CompactTxStreamer/GetBridgeTreeState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompactTxStreamerServer).GetBridgeTreeState(ctx, req.(*BlockID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CompactTxStreamer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBridgeTreeState",
			Handler:    _CompactTxStreamer_GetBridgeTreeState_Handler,
		},
		{
