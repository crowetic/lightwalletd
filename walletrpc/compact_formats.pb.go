...
func (*CompactBlock) Descriptor() ([]byte, []int) {
	return file_compact_formats_proto_rawDesc, []int{0}
}
...
func (*CompactTx) Descriptor() ([]byte, []int) {
	return file_compact_formats_proto_rawDesc, []int{1}
}
...
func (*CompactSaplingSpend) Descriptor() ([]byte, []int) {
	return file_compact_formats_proto_rawDesc, []int{2}
}
...
func (*CompactSaplingOutput) Descriptor() ([]byte, []int) {
	return file_compact_formats_proto_rawDesc, []int{3}
}
...
func (*CompactOrchardAction) Descriptor() ([]byte, []int) {
	return file_compact_formats_proto_rawDesc, []int{4}
}
...
func init() {
	proto.RegisterFile("compact_formats.proto", file_compact_formats_proto_rawDesc)
}
